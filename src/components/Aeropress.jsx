    ...
    <ScrollContainer ref={ref} background={'#19224f'}>
      <Main>
        <Title fontStack="Barbour" style={{ opacity }}>
          ...
          <Story>
            It might not have the glamour of a Chemex. There are also
            a lot of confusingly large accessories. But take a chance
            on this tiny plastic plunger just once — and you might
            discover it can produce the most naturally sweet coffee of
            your dreams.
          </Story>
        </Main>
      </ScrollContainer>
