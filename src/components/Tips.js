  ...
  return (
    <ScrollContainer background={'#19224F'}>
      <Main ref={ref} style={{ opacity }}>
        ...
        <Tip className="u-Cross">
          <a href="https://www.bonappetit.com/story/how-to-buy-coffee-beans">
            <TipHeading>
              Call Me Extra, But I Won’t Go On Vacation Without My
              Travel Coffee Kit
            </TipHeading>
            <TipBody>
              <em>Bon Appetit's</em> Chris Morocco talks about how to
              travel with a manual coffee brewing setup.
            </TipBody>
          </a>
        </Tip>
      </Main>
